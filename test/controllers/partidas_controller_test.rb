...
class PartidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partida" do
    assert_difference('Partida.count') do
      post partidas_url, params: { partida: { Data: @partida.Data, Horario: @partida.Horario, Local: @partida.Local, id_partida: @partida.id_partida } }
    end
  ...
  test "should update partida" do
    patch partida_url(@partida), params: { partida: { Data: @partida.Data, Horario: @partida.Horario, Local: @partida.Local, id_partida: @partida.id_partida } }
